      ...
      items: [
        {
          ...
          description:
            "Приказ Министерства просвещения РФ от 31 мая 2021 г. № 286",
          link: "#",
        },
        {
        ...
        },
        {
          ...
          description:
            "Приказ Министерства образования и науки РФ от 17 мая 2012 г. № 413",
          link: "#",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Документ содержит перечень требований к результатам обучения",
          link: "#",
        },
      ],
    },
      ...
      <section className="bg-gradient-to-b from-cyan-50 to-white dark:from-slate-950 dark:to-slate-900 py-12">
        <div className="container">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl">
            В этом разделе собраны основные нормативные документы,
            регламентирующие образовательную деятельность по иностранным языкам.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="container">
            ...
            {documents.map((category, index) => (
              <Card key={index}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Нормативные документы, относящиеся к категории "
                    {category.category}"
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <div className="mt-12 p-6 bg-muted rounded-lg">
            ...
            <p className="mb-4">
              Все представленные документы являются действующими на момент
              публикации. Следите за обновлениями нормативной базы, так как в
